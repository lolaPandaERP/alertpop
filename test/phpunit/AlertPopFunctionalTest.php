...
/**
 * \file    test/phpunit/AlertPopFunctionalTest.php
 * \ingroup alertpop
 ...
 *
 * @package Testalertpop
 */
class AlertPopFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/alertpop/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('alertpop/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/alertpop/admin/about.php');
		$this->authenticate();
		return $this->assertContains('alertpop/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('alertpopwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAlertPop_AlertPopTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAlertPop_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
